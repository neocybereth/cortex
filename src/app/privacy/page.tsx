      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-lg font-medium text-black mb-2">Oura Ring Data</h3>
            <p className="text-black mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-black mb-4">Data Storage and Security</h2>
            <p className="text-black mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-black mb-4">Data Retention</h2>
            <p className="text-black mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibent text-black mb-4">Changes to This Policy</h2>
            <p className="text-black mb-4">
